...
def get_eval5_training_set_scene_name(root, entry_fields):
    # scene files were copied into names of this form:  grav_L1_A1_plaus_correct_oscar_0003_01
    type = type_abbrev[entry_fields[val_index["TERTIARY TYPE"]]]
    cube = entry_fields[val_index["CUBE/SCENE GOAL ID"]]
    plaus_abbrev = plausibility_abbrev[
    ...
    return type + "_" + root + "_" + cube + "_" + plaus_abbrev
...
class EvalResults:
    def __init__(self, answer_key_lines):
        ...
        # self.scene_files_for_outcome = {}
        # self.scene_files_for_outcome['plausible_Correct'] = []
        # self.scene_files_for_outcome['plausible_Incorrect'] = []
        # self.scene_files_for_outcome['implausible_Correct'] = []
        # self.scene_files_for_outcome['implausible_Incorrect'] = []
        ...
        for answer_key_line in answer_key_lines:
            ...
            self.scene_filename_for_root[
                scene_name_root
            ] = get_eval5_training_set_scene_name(scene_name_root, parts)
            # self.scene_files_for_outcome[plausibility + '_' + correctness].append(scene_name)
        ...
        # print("completed answer_key load")
